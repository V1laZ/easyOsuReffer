<template>
  <div class="bg-gradient-to-br h-[100dvh] from-gray-900 via-purple-900 to-pink-900 flex items-center justify-center px-4 py-8">
      ...
      <div class="bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-pink-500/20">
        ...
        >
          ...
          <div class="space-y-2">
            <label
              for="username"
              class="block text-sm font-medium text-pink-200"
            >
              osu! Username
            </label>
            <div class="relative">
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              >
                <svg
                  v-if="showPassword"
                  class="w-5 h-5 text-gray-400 hover:text-pink-400 transition-colors"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div class="flex items-center">
            ...
            <label
              for="remember"
              class="ml-2 text-sm text-pink-200"
            >
        ...
        <div
          ...
          :class="connectionStatus.type === 'error' ? 'bg-red-900/50 border border-red-500/50' : 'bg-green-900/50 border border-green-500/50'"
        >
          <div class="flex items-center">
            <svg
            ...
            <span
              class="text-sm"
              :class="connectionStatus.type === 'error' ? 'text-red-300' : 'text-green-300'"
            >
        ...
        <div class="mt-6 pt-4 border-t border-gray-600">
          <div class="text-center space-y-2">
            <a
              role="button"
              href="#"
              class="text-pink-400 hover:text-pink-300 text-sm transition-colors"
    ...
    >
      <div
        class="bg-gray-800 rounded-2xl p-6 max-w-md w-full border border-pink-500/20"
        @click.stop
      >
        <h3 class="text-lg font-semibold text-white mb-4">
          Getting your IRC Password
        </h3>
        ...
        <button
          class="mt-4 w-full bg-pink-500 hover:bg-pink-600 text-white py-2 rounded-xl transition-colors"
          @click="showHelp = false"
        >
          Got it!
        </button>
