    ...
    >
      ...
      >
        ...
        <span
          ...
          class="ml-auto flex-shrink-0 rounded-full bg-pink-500/15 px-2 py-0.5 text-[10px] font-semibold text-pink-200 ring-1 ring-inset ring-pink-400/30"
        >
      ...
      <button
        class="mr-1 inline-flex size-7 flex-shrink-0 items-center justify-center rounded-md opacity-100 transition-colors md:opacity-0 group-hover:opacity-100"
        :class="isActive
...
const iconName = computed<IconName>(() => {
  ...
  if (props.room.roomType === 'MultiplayerLobby') return 'group'
  return 'user'
})
</script>
