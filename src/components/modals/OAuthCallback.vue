<template>
  ...
  >
    <div class="absolute top-3 right-3">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M19.41 6.58L17.83 5l-7.59 7.59L2.83 5 1.41 6.41l7.59 7.59L1.41 21l1.42 1.41L12 14.83l7.59 7.58L21 21l-7.59-7.59z"/></svg>
      </button>
    </div>
    <div class="p-4">
      <LoadingText 
